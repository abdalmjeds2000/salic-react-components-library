...
function PhoneExtensionsFields() {
  ...
  return (
    <>
      <Form.Item name="Scope" label="Scope" rules={[{ required: true, message: "" }]} initialValue="Mobile Calls">
      ...
      <Form.Item name="Extensions" label="Extensions" rules={[{ required: true, message: "" }]}>
