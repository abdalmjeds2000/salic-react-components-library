...
function GLAccountFields() {
  ...
  const handleFinancialStatementChange = (value : string) => {
    ...
    <div className="new-account-fields-container">
      ...
      <Form.Item label="Account Information" rules={[{ required: true, message: '' }]}>
        ...
        <Form.Item rules={[{ required: true }]} style={{margin: 0}}>
          ...
          <Form.Item name="FinancialStatement" rules={[{ required: true, message: '' }]} style={{ margin: 0, display: 'inline-block', width: 'calc(50% - 5px)' }} >
          ...
          <Form.Item name="MappingUnderFSLI" rules={[{ required: true, message: '' }]} style={{ display: 'inline-block', width: 'calc(50% - 5px)', margin: '0 0 0 10px' }} >
            <Select placeholder="Select Value">
              {values?.map((elmnt: any) => <Select.Option value={elmnt.Value}>{elmnt.Value}</Select.Option>)}
            </Select>
          </Form.Item>
        </Form.Item>
      </Form.Item>
